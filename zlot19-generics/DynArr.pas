...
type
  ...
  public
    ...
    ///  @TODO: add a mapper to string or require a type helper
    ...
    procedure sort(compare: TFunc<T, T, Integer>);
    function sorted(compare: TFunc<T, T, Integer>): TDynArr<T>;
    ...
    ///  @TODO: BitwiseAnd - return an array consisting of items common
    ///  to a1 and a2
...
begin
  System.SetLength(self._items, 20);
end;
...
begin
  Result := TDynArr<T>.itemsEqual(i1, i2);
end;
...
procedure TDynArr<T>.sort(compare: TFunc<T, T, Integer>);
begin
  //@TODO
end;

function TDynArr<T>.sorted(compare: TFunc<T, T, Integer>): TDynArr<T>;
begin
  Result := TDynArr<T>.from(self);
  Result.sort(compare);
end;
...
function TDynArr<T>.toString: string;
begin
  //@TODO
end;
